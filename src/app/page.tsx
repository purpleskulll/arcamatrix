  ...
  return (
    <main className="min-h-screen">
      ...
      <nav className="fixed top-0 w-full z-50 bg-arca-darker/80 backdrop-blur-md border-b border-white/10">
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-white/10 bg-arca-darker/95 backdrop-blur-md">
            <div className="px-4 py-4 space-y-3">
              ...
              <a href="#skills" onClick={() => setMobileMenuOpen(false)} className="block text-gray-300 hover:text-white transition py-2">Skills</a>
              <a href="#pricing" onClick={() => setMobileMenuOpen(false)} className="block text-gray-300 hover:text-white transition py-2">Pricing</a>
              <a href="/login" className="block w-full text-center px-4 py-2 rounded-lg bg-arca-primary hover:bg-arca-secondary transition">
                Login
              </a>
            </div>
          </div>
